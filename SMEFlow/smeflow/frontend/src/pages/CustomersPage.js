  ...
  return (
    <Layout>
      ...
      <div className="card">
        ...
        {loading ? (
          <div style={{ display: 'flex', gap: 12, padding: '40px 0', color: 'var(--text-muted)', justifyContent: 'center' }}><Spinner /> Loading customers…</div>
          ...
          footer={
            <>
              ...
              <button className="btn btn-primary" onClick={handleSubmit} disabled={saving}>
                {saving ? <><Spinner /> Creating…</> : 'Create Customer'}
              </button>
            </>
          }
        >
